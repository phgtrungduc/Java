...
public class Connect {
    ...
    public static Connection getConnect() {
        ...
        try {
            ...
            connection = (Connection) DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=DataLogin;user=sa;password=duc123456");
    ...
    public int createData(String sql) throws SQLException {
        Connection connect = getConnect(); // cái này là hàm kết nối
        Statement stmt = connect.createStatement();// tạo ra đối tượng truy xuất vào database
        int check = stmt.executeUpdate(sql);//truy cập vào database
        return check;
    }
}
