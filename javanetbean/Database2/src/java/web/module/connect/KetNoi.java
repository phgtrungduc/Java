...
public class KetNoi {
	...
	public static Connection getConnect(){
		...
		try {
			...
			connection=DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=ClassManagement;user=duc;password=duc123456");
