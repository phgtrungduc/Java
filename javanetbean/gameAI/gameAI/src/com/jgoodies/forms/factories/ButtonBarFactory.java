...
public final class ButtonBarFactory
{
    ...
    {
        return buildWizardBar(back, next, new JButton[] {
            finish, cancel
        });
    }
    ...
    {
        return buildWizardBar(new JButton[] {
            help
        }, back, next, new JButton[] {
            finish, cancel
        });
    }
    ...
    {
        return buildWizardBar(((JButton []) (null)), back, next, rightAlignedButtons);
    }
